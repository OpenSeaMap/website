...
$german = array(
	...
	"unknown"=>"Unbekannt",
	"comment"=>"Kommentar",
	"loged_in"=>"Sie sind angemeldet",
	"loged_out"=>"Sie müssen amgemeldet sein um die Karte bearbeiten zu können.",
	"loged_out_save"=>"Sie müssen amgemeldet sein um die Daten zu speichern.",
...
$english = array(
	...
	"unknown"=>"Unknown",
	"comment"=>"Comment",
	"loged_in"=>"(en)Sie sind angemeldet",
	"loged_out"=>"(en)Sie müssen amgemeldet sein um die Karte bearbeiten zu können.",
	"loged_out_save"=>"(en)Sie müssen amgemeldet sein um die Daten zu speichern.",
	"enterComment"=>"(en)Sie müssen einen Kommentar eingeben!",
	...
	"seamarkAdd"=>"(en)Seezeichen hinzufügen",
	"seamarkEdit"=>"(en)Seezeichen bearbeiten",
	"seamarkDelete"=>"(en)Seezeichen löschen",
	"seamarkMove"=>"(en)Seezeichen verschieben",
	"seamarkSave"=>"(en)Seezeichen speichern",
	"seamarkCategory"=>"(en)Art des Zeichens",
	"seamarkType"=>"(en)Bauart des Zeichens",
	"seamarkName"=>"(en)Name des Zeichens",
